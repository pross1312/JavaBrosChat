...
public class AdminService extends Service {
    ArrayList<UserInfo> list_users(String token) throws SQLException {
    ...
    ArrayList<UserInfo> list_active_users(String token, Date from, Date to) throws SQLException{
        var acc = Server.accounts.get(token);
        if (acc == null)
    ...
    ArrayList<UserInfo> list_user_friends(String token, String username) throws SQLException{
        ...
        return UserFriendDb.list_friends_info(username);
    }
    // group-operations
    ArrayList<GroupChatInfo> list_groups(String token) throws SQLException {
        ...
        return GroupChatDb.list_all_group_chats();
    }
